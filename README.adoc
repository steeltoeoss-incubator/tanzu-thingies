...
* link:#_minikube_cluster[cluster is running]
* link:#_minikube_tunnel[tunnel is running]
* link:#_tap_tools[TAP product bundles] are downloaded into expected paths
