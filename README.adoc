...
| Linux | `local/distfiles/tanzu-framework-linux-amd64-1.3.0-rc.1.tar`
| OS X | `local/distfiles/tanzu-framework-darwin-amd64-1.3.0-rc.1.tar`
| Windows |`local/distfiles/tanzu-framework-windows-amd64-1.3.0-rc.1.zip`
|===
