...
...
NAME              READY   URL
weatherforecast   Ready   http://weatherforecast.default.example.com
----

Add a host entry for `weatherforecast.default.example.com`.

----
127.0.0.1 weatherforecast.default.example.com
----

Access the app.

----
PS> curl http://weatherforecast.default.example.com/
----
