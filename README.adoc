...
| `tap-configuration.ps1` | Creates TAP configuration.
...
Generate a TAP Configuration based on your settings.
You only need to do this once, or when you've changed settings.

----
PS> bin/tap-configuration.ps1
----

This generates the file `etc/tap-values.yaml`.
